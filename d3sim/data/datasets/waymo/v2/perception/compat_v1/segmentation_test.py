...
from d3sim.data.datasets.waymo.v2.perception import camera_image as _v2_camera_image
...
from d3sim.data.datasets.waymo.v2.perception.compat_v1 import segmentation
from d3sim.data.datasets.waymo.v2.perception.utils import lidar_utils
