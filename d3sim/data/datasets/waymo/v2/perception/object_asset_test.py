...
from d3sim.data.datasets.waymo.v2.perception import camera_image as _lib_camera
from d3sim.data.datasets.waymo.v2.perception import object_asset as _lib
